...
static const char *fonts[]          = { "JetBrains Mono Medium:size=10","monospace:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
const char *spcmd2[] = {"st", "-n", "spcalc", "-f", "JetBrains:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{"Pamac-manager",		NULL,		NULL,		1<<8,		0,	-1},
